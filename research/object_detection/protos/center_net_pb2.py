...
_CENTERNET = _descriptor.Descriptor(
  ...
  nested_types=[_CENTERNET_OBJECTDETECTION, _CENTERNET_OBJECTCENTERPARAMS, _CENTERNET_KEYPOINTESTIMATION, _CENTERNET_MASKESTIMATION, _CENTERNET_DENSEPOSEESTIMATION, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
