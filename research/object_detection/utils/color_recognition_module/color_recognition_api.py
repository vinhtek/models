...
from object_detection.utils.color_recognition_module import color_histogram_feature_extraction
from object_detection.utils.color_recognition_module import knn_classifier
import os
from object_detection.utils.image_utils import crop_image
...
def color_recognition(crop_img):
    ...
    open(current_path + '/object_detection/utils/color_recognition_module/' + 'test.data', 'w')
    ...
    prediction = knn_classifier.main(current_path
            + '/object_detection/utils/color_recognition_module/' + 'training.data',
            current_path + '/object_detection/utils/color_recognition_module/'
            + 'test.data')
